...
same arithmetic and scratch. [Explicit complete grouped hierarchies](ISSUE5_GROUPED_HIERARCHY.md)
...
timing gain is claimed. The [single-arena workspace](ISSUE5_TRAVERSAL_ARENA.md)
...
[One-transition provisional replay](ISSUE5_PROVISIONAL_REPLAY.md)
...
exact M6f numerical/work/payload/layout records. The [terminal-first component driver](ISSUE5_COMPONENT_DRIVER.md) now integrates
...
[sparse-terminal memory and execution boundary](ISSUE5_SPARSE_TERMINAL_BOUNDARY.md). The
[serial Schwarz dependency workspace](ISSUE5_SERIAL_SCHWARZ_WORKSPACE.md) now provides fixed-order,
